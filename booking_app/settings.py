...
STRIPE_BOOKING_OFF_PEAK_PRICE_PENCE = int(
    os.getenv("STRIPE_BOOKING_OFF_PEAK_PRICE_PENCE", str(STRIPE_BOOKING_PRICE_PENCE))
)
STRIPE_BOOKING_PEAK_PRICE_PENCE = int(
    os.getenv(
        "STRIPE_BOOKING_PEAK_PRICE_PENCE",
        str(STRIPE_BOOKING_OFF_PEAK_PRICE_PENCE + 500),
    )
)
